...
const CATEGORIES = ["Work", "Personal", "Learning", "Ideas", "Health", "Travel", "Finance", "Other"];
...
const MemoryFormModal = ({ memory, onClose, onSave }) => {
  const { generateAISummary, generateAITags, findRelatedMemories, aiLoading, memories } = useMemories();
...
const TopBar = ({ currentPage, onCapture }) => {
  const PAGE_TITLES = { memories: "Memories", archived: "Archived", trash: "Trash" };
  return (
    ...
    <div style={{ display: "flex", height: "100vh", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, overflowY: "auto" }}>
          <MemoriesPage
            key={currentPage}
            initialView={currentPage === "archived" ? "archived" : currentPage === "trash" ? "trash" : "timeline"}
          />
        </div>
      </div>
      {showCapture && (
