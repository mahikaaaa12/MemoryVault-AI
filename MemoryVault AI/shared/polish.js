/* ============================================================
   ...
   button ripple, and a tiny focus trap for modals.
   Safe to include on every page; degrades gracefully if a
   given element isn't present.
   ============================================================ */
(function () {
  "use strict";
  ...
  window.mvTrapFocus = function (modalEl) {
